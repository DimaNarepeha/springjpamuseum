    ...
    <div class="w3-card-4">
        ...
        <div>
            <%
                if (request.getAttribute("updated") != null && !request.getAttribute("updated").equals(0)) {
                    out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                            ...
                            "   <h5>Exhibit '" + request.getParameter("exhibit_name") + "' was updated!</h5>\n" +
                            "</div>");
                }
            %>
            <%
            ...
            <form method="post" class="w3-selection w3-light-grey w3-padding">
                <label>Exhibit name :</label> <input type="text" name="exhibit_name" placeholder="Exhibit Name" value="<%if(request.getParameter("exhibit_name")!=null){
